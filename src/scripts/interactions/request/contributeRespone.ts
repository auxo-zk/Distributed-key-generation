...
async function main() {
  ...
  Provable.log('commitee address: ', ZkAppRef.fromJSON(data.committee).address);
  Provable.log(
    'commitee root: ',
  ...
  Provable.log('commitee r1: ', ZkAppRef.fromJSON(data.round1).address);
  Provable.log(
    'commitee root: ',
  ...
  Provable.log('commitee r2: ', ZkAppRef.fromJSON(data.round2).address);
  Provable.log(
    'commitee root: ',
