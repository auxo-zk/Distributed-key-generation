...
//     const sender = await fetchAccount({ publicKey: account.publicKey });
...
//   let RValue: RequestVector = RequestVector.from([
//     PublicKey.fromBase58(acc3.publicKey).toGroup(),
//     PublicKey.fromBase58(acc3.publicKey).toGroup(),
//   ]);

//   let inputRequest: RequestInput = new RequestInput({
//     committeeId: Field(0),
//     keyId: Field(0),
//     R: RValue,
//   });

//   let actionRequest: RequestAction = new RequestAction({
//     requestId: inputRequest.requestId(),
//     newRequester: PublicKey.fromBase58(acc3.publicKey),
//     R: RValue,
//     D: RequestVector.empty(),
//     actionType: createActionMask(Field(ReqeustACtionEnum.REQUEST)),
//   });

//   let requestId = inputRequest.requestId();
...
//   console.log('Create committe');
//   let committeeContract = contracts[Contract.COMMITTEE]
//     .contract as CommitteeContract;
...
//   });
//   // tx = await Mina.transaction(
//   //   { sender: members[0].publicKey, fee, nonce: ++memberNonces[0] },
//   //   () => {
//   //     committeeContract.createCommittee(committeeAction);
//   //   }
//   // );
//   // await tx.prove();
//   // await tx.sign([members[0].privateKey]).send();

//   console.log('Account 3 request contract Request');
//   // tx = await Mina.transaction(
//   //   { sender: accounts[2].publicKey, fee, nonce: ++memberNonces[2] },
//   //   () => {
//   //     requestContract.request(inputRequest);
//   //   }
//   // );
//   // await tx.prove();
//   // await tx.sign([accounts[2].privateKey]).send();
//   // console.log('RequestContract.request');
...
//   //   proof,
//   //   actionRequest,
//   //   requestStatusMap.getWitness(inputRequest.requestId()),
//   //   requesterMap.getWitness(inputRequest.requestId()),
//   //   actionRequest.newRequester
//   // );
...
//     Poseidon.hash(PublicKey.toFields(actionRequest.newRequester))
//   );
...
//   );
//   // let initialDKGActionState = Reducer.initialActionState;
...
//   Provable.log(
//     'Round2 action state: ',
//     contracts[Contract.ROUND2].actionStates
//   );
//   Provable.log(
//     'round2Actions 0: ',
...
//   // let temp = round2Actions[0];
//   // round2Actions[0] = round2Actions[1];
//   // round2Actions[1] = temp;
...
//   // let temp2 = contracts[Contract.ROUND2].actionStates[1];
//   // contracts[Contract.ROUND2].actionStates[1] =
//   //   contracts[Contract.ROUND2].actionStates[2];
//   // contracts[Contract.ROUND2].actionStates[2] = temp2;
...
//   console.log(
//     'Contract actionState last oout side: ',
//     requestContract.actionState.get()
//   );
//   console.log('Contract action before responee oout side: ');
//   await Mina.fetchActions(contracts[Contract.REQUEST].contract.address).then(
//     (actions) => {
//       Provable.log(actions);
//       if (Array.isArray(actions)) {
//         for (let action of actions) {
//           Provable.log(
//             'requestAction oout side: ',
