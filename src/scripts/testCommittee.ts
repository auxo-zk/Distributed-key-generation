...
async function main() {
  ...
  console.log(
    'myGroupArray0 ',
    PublicKey.fromGroup(myGroupArray.get(Field(0))).toBase58()
  );
  console.log(
    'myGroupArray4 ',
    PublicKey.fromGroup(myGroupArray.get(Field(4))).toBase58()
  );
  console.log(
    'myGroupArray5 ',
    PublicKey.fromGroup(myGroupArray.get(Field(5))).toBase58()
  );
  // create proof
  console.log('compile...');
  ...
  ActionCommitteeProfiler.start(
    'createCommitteeProve create proof with 5 memeber'
  );
