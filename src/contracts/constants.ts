...
export enum ErrorEnum {
    ...
    R2_CONTRIBUTION_ORDER = 'Incorrect round 2 contribution order',
    R2_CONTRIBUTION_THRESHOLD = 'Incorrect number of round 1 contributions',
    R2_CONTRIBUTION_VALUE = 'Incorrect round 1 contribution value',
    R2_CONTRIBUTION_KEY_INDEX = 'Incorrect key index',
    R2_CONTRIBUTION_ROOT = 'Incorrect round 1 contribution MT root',
    R2_CONTRIBUTION_KEY_L1 = 'Incorrect round 1 contribution MT level 1 key',
    R2_CONTRIBUTION_KEY_L2 = 'Incorrect round 1 contribution MT level 2 key',
    INITIAL_ENCRYPTION_HASHES = 'Incorrect initial encryption hash values',
    ENCRYPTION_ROOT = 'Incorrect round 1 public key MT root',
    ENCRYPTION_KEY_L1 = 'Incorrect round 1 public key MT level 1 key',
    ENCRYPTION_KEY_L2 = 'Incorrect round 1 public key MT level 2 key',

    // ResponseContract errors
    RES_CONTRIBUTION_ROOT = 'Incorrect round 1 contribution MT root',
    RES_CONTRIBUTION_KEY_L1 = 'Incorrect round 1 contribution MT level 1 key',
    RES_CONTRIBUTION_KEY_L2 = 'Incorrect round 1 contribution MT level 2 key',
}
